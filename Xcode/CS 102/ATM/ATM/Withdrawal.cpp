...
Withdrawal::Withdrawal(int userAccountNumber, double Checkings, double Savings, Screen &atmScreen,
...
void Withdrawal::execute(int Checkings = 'c', int Savings = 's')
{
      ...
      if ( selection != CANCELED )
      {
         ...
         {   
            ...
            if ( cashDispenser.isSufficientCashAvailable( amount ) )
            {
               ...
               bankDatabase.debitC( getAccountNumber(), amount);
         ...
         else // not enough money available in user's account
         {
          ...
          if (acc == 's') {
              if ( amount <= Saving )
              {
                  ...
                  {
                      // update the account involved to reflect withdrawal
                      bankDatabase.debitS( getAccountNumber(), amount);
