...
Deposit::Deposit(int userAccountNumber, double Checkings, double Savings, Screen &atmScreen,
...
void Deposit::execute(int Checkings = 'c', int Savings = 's')
{
   ...
   if ( amount != CANCELED )
   {
      ...
      {  
         ...
         bankDatabase.creditC( getAccountNumber(), amount );
      } // end if
